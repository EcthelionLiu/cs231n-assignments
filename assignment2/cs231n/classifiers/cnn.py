...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out2, fc1_cache = affine_relu_forward(out1, W2, b2)
        scores, fc2_cache = affine_forward(out2, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx, dw, db = affine_backward(dout, fc2_cache)
        grads["W3"] = dw + self.reg * self.params["W3"]
        grads["b3"] = db
        
        dx, dw, db = affine_relu_backward(dx, fc1_cache)
