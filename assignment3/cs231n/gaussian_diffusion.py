...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        ####################################################################
        alpha_sqrt = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        sigma = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        x_start =  (x_t - sigma * noise) / alpha_sqrt
        ####################################################################
        return x_start
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        pred_noise =  (x_t - alpha_sqrt * x_start) / sigma
        ####################################################################
        return pred_noise
    ...
    def p_sample(self, x_t, t: int, model_kwargs={}):
        ...
        #      and sample x_{t-1}.
        ##################################################################
        x_start = self.model(x_t, t, model_kwargs) # x_0
    ...
    def p_losses(self, x_start, model_kwargs={}):
        ...
        loss = (loss_weight * (target - y) ** 2).mean()
        ####################################################################
